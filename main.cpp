...
int main() {
    ...
    cout << "================" << endl << endl;
	vector<vector<string>> items{ { "Kniper Rifle","3" },{ "Kar98K", "10" },{ "AWM","15" } ,{ "LMG","50" },{"GATLING","100"} }; //item pool
	...
	cout << "Jumlah item tersedia : " << maksItem << endl; //tampilkan jumlah item di item pool
